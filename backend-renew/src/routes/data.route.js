...
router.get('/refer/:refer', auth(), awaitHandlerFactory(dataController.getDataByRefer)); // localhost:3000/api/v1/data/refer/이노동물병원
router.post('/', createDataSchema, awaitHandlerFactory(dataController.createData)); // localhost:3000/api/v1/data
